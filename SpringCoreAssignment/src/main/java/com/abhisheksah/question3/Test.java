...
public class Test {
	...
	public static void main(String[] args) {
		ApplicationContext context = new ClassPathXmlApplicationContext("com/abhisheksah/question3/bank.xml");
		BankAccountController accountController = (BankAccountController) context.getBean("controller");
		BankAccountRepository accountRepository=(BankAccountRepository)context.getBean("repository");
